...
hero:
  ...
  tagline: Веб-приложение для мессенджера MAX — создание событий, регистрация участников и контроль посещаемости институтов СКФУ
  actions:
    - theme: brand
      text: Начать работу
...
features:
  ...
  - icon: 🔐
    title: Безопасность
    details: Token-авторизация, валидация данных через Zod, ролевой контроль доступа к API
---
